 ...
 */
class Database extends Cache implements BackendInterface
{
    use Prefixable;
    ...
    public function __construct(FrontendInterface $frontend, array $options)
    {
        ...
        $this->table = $this->db->escapeIdentifier(
            $options['table']
        );
